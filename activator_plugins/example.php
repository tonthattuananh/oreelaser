...
function mt_register_required_plugins() {
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'gaumap' ),
			'menu_title'                      => __( 'Install Plugins', 'gaumap' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'gaumap' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'gaumap' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'gaumap' ),
